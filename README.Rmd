...
The `quartositebuildr` R package automates the setup of a project website using [Quarto](https://quarto.org/), specifically designed for Code for America-style research projects. It creates a consistent folder structure, prepopulated Quarto files, and branded assets — making it easy to get started on data-sharing or internal collaboration websites.
...
Each .qmd file contains a Quarto-compatible YAML header and default section text:
...
- After creation, open the .qmd files in RStudio or VS Code to edit content.
- Run quarto preview to preview the site locally.
- You can deploy to GitHub Pages or Netlify using Quarto’s built-in tools.

## Feedback

Please open an issue on GitHub if you encounter bugs or have suggestions for new features.
